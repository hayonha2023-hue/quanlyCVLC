...
def apply_workspace_theme(dark=False):
    ...
    .workspace-brand small {display:block;color:var(--muted);font-size:13px;margin-top:3px;}
    ...
    .workspace-context {display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap;border-bottom:1px solid var(--line);padding:0 0 13px;margin-bottom:4px;color:var(--muted);font-size:14px;}
    ...
    @media(max-width:700px) {
      ...
      .workspace-context {font-size:13px;gap:5px;}
      ...
      .st-key-overview_metrics [data-testid="stMetricLabel"] p {font-size:13px;white-space:normal;}
      .st-key-overview_metrics [data-testid="stMetricValue"] {font-size:23px!important;}
      .workspace-steps {gap:8px;font-size:13px;}
    }
